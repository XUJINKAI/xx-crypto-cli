...
#define LOG_SECRET(...)   _log_fmt_content(_LOGT_SECRET, _LOGF_PROG, _LOGC_SECRET, __VA_ARGS__)
...
#define LOG_SECRET_HEX(title, data, len)   _log_hex_content(_LOGT_SECRET, _LOGF_PROG, _LOGC_SECRET, title, data, len)
